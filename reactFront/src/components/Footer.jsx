...
function Footer() {
  ...
  return (
    <footer className={`${contenedor} d-flex flex-column p-2  flex-xl-row justify-content-xl-end align-items-end`}>
        <div className="footer__cont--img d-flex flex-row col-10 align-items-center justify-content-end gap-3 col-lg-6 col-md-6 col-xl-4  justify-content-xl-end pe-xl-4">
